...
colnames(dFilt1_Diff) = c("  ", " ")
dFilt1_Diff = dFilt1_Diff[order(dFilt1_Diff[,1]),]
outputFileName = 'matrix_pvalue_diff_hmgb1-hmgb2B.eps'
heatmapDiffTitle = 'TF Enrichment in Footprints\n(-log10(HMGB1)) - (-log10(HMGB2(Broad)))'
createHeatmapDiff(dFilt1_Diff,heatmapDiffTitle,hmcol,hmbreaks,wid1,hei1,mx1,my1,cexRow1,outputFileName)
outputFileName = 'matrix_pvalue_diff_hmgb1-hmgb2B_out.txt'
write.table(dFilt1_Diff, file = outputFileName, sep='\t', append = FALSE)

dFilt1_Diff = as.matrix(dFilt1_All[,1]) - as.matrix(dFilt1_All[,3])
dFilt1_Diff <- cbind (dFilt1_Diff, dFilt1_Diff)
colnames(dFilt1_Diff) = c("  ", " ")
dFilt1_Diff = dFilt1_Diff[order(dFilt1_Diff[,1]),]
outputFileName = 'matrix_pvalue_diff_hmgb1-hmgb2N.eps'
heatmapDiffTitle = 'TF Enrichment in Footprints\n(-log10(HMGB1)) - (-log10(HMGB2(Narrow)))'
createHeatmapDiff(dFilt1_Diff,heatmapDiffTitle,hmcol,hmbreaks,wid1,hei1,mx1,my1,cexRow1,outputFileName)
outputFileName = 'matrix_pvalue_diff_hmgb1-hmgb2N_out.txt'
write.table(dFilt1_Diff, file = outputFileName, sep='\t', append = FALSE)

dFilt1_Diff = as.matrix(dFilt1_All[,2]) - as.matrix(dFilt1_All[,3])
dFilt1_Diff <- cbind (dFilt1_Diff, dFilt1_Diff)
colnames(dFilt1_Diff) = c("  ", " ")
dFilt1_Diff = dFilt1_Diff[order(dFilt1_Diff[,1]),]
outputFileName = 'matrix_pvalue_diff_hmgb2B-hmgb2N.eps'
heatmapDiffTitle = 'TF Enrichment in Footprints\n(-log10(HMGB2(Broad))) - (-log10(HMGB2(Narrow)))'
createHeatmapDiff(dFilt1_Diff,heatmapDiffTitle,hmcol,hmbreaks,wid1,hei1,mx1,my1,cexRow1,outputFileName)
outputFileName = 'matrix_pvalue_diff_hmgb2B-hmgb2N_out.txt'
write.table(dFilt1_Diff, file = outputFileName, sep='\t', append = FALSE)
